...
<html lang="en">
  <head>
    ...
    <title>Enrolled Students — Saif Academy Admin</title>
  ...
  <body>
    <div class="min-h-screen flex">
      ...
      <aside id="sidebar" class="bg-slate-800 text-slate-200 p-4 shadow-lg">
        ...
        <nav class="mt-4">
          ...
          >
          <a href="enrolled-students.html" class="sidebar-link active"
        ...
        <div class="mt-auto px-2 pt-6">
          ...
          <div class="flex gap-2 mt-2">
            <button id="importStudents" class="btn btn-sm btn-light w-full">
        ...
        <main class="p-4 container-fluid">
          ...
          >
            ...
            <div class="ms-auto d-flex gap-2">
              <button id="exportStudents" class="btn btn-outline-secondary btn-sm">
                <i class="fa-solid fa-file-export me-1"></i> Export
              </button>
              <a href="#" class="btn btn-primary btn-sm"
                ><i class="fa-solid fa-plus me-1"></i> Add Student</a
              >
            </div>
          </div>
          ...
          <div class="card card-premium p-0 overflow-hidden">
            <div class="card-body p-3">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="text-muted small">Total: {{total_students}}</div>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                  <thead class="table-light">
                    <tr>
                      <th style="width: 38px"><input type="checkbox" id="selectAllRows" /></th>
                      <th>Student</th>
                      <th class="hide-xs">Email</th>
                      <th class="hide-xs">Enrolled Courses</th>
                  ...
                  <tbody id="studentsTableBody">
                    ...
                    <tr>
                      ...
                      <td class="hide-xs">{{student_email}}</td>
                      <td class="hide-xs">
                        <div class="text-muted small">
                          {{enrolled_courses}}
                          <!-- e.g. "HTML Basics, JS Intro" -->
                        </div>
                      </td>
                      <td>
                    ...
                    <!-- empty placeholder -->
                    <tr id="noStudents" style="display: none">
                      <td colspan="6" class="text-center text-muted small py-4">
                        No students found. Use filters or import CSV to add students.
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="d-flex justify-content-between align-items-center mt-3">
            <div>
              <button id="messageSelected" class="btn btn-sm btn-outline-primary me-2">
                Message Selected
              </button>
              <button id="activateSelected" class="btn btn-sm btn-success me-2">Activate</button>
              <button id="suspendSelected" class="btn btn-sm btn-outline-danger">Suspend</button>
            </div>
          ...
          <footer class="mt-5 text-center text-muted small">
            Saif Academy Admin — Student Management
          </footer>
        </main>
      </div>
    </div>
    ...
    <script>
      ...
      // Simple client-side filter demo (for static placeholders)
      $('#searchInput, #courseFilter, #statusFilter').on('input change', function () {
        console.log(
          'Filter changed',
          $('#searchInput').val(),
          $('#courseFilter').val(),
        ...
        // Replace with server-side filtering / AJAX in real app
      });
    </script>
  </body>
</html>
