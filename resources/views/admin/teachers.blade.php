...
<html lang="en">
  ...
  <body>
    <div class="min-h-screen flex">
      ...
      <aside id="sidebar" class="bg-slate-800 text-slate-200 p-4 shadow-lg">
        ...
        <nav class="mt-4">
          ...
          >
          <a href="teachers.html" class="sidebar-link active"
        ...
        <main class="p-4 container-fluid">
          ...
          >
            ...
            <div class="ms-auto d-flex gap-2">
              <button id="exportTeachers" class="btn btn-outline-secondary btn-sm">
                <i class="fa-solid fa-file-export me-1"></i> Export
              </button>
              <a href="#" class="btn btn-primary btn-sm"
                ><i class="fa-solid fa-plus me-1"></i> Add Teacher</a
              >
            </div>
          </div>
          ...
          <div class="card card-premium p-0 overflow-hidden">
            <div class="card-body p-3">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="text-muted small">Total: {{total_teachers}}</div>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                  ...
                  <tbody id="teachersTableBody">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          ...
                          <div>
                            ...
                            <div class="text-muted small">{{teacher_joined}}</div>
                          </div>
                        </div>
                      </td>
                      <td class="hide-xs">{{teacher_email}}</td>
                      <td class="hide-xs">
                        <div class="text-muted small">{{courses_assigned}}</div>
                      </td>
                      ...
                      <td class="text-end action-btns">
                        ...
                        <button
                          ...
                          onclick="confirmDelete('{{teacher_name}}')"
                        >
                    ...
                    <!-- empty placeholder -->
                    <tr id="noTeachers" style="display: none">
                      <td colspan="6" class="text-center text-muted small py-4">
                        No teachers found. Add instructors or import via CSV.
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="d-flex justify-content-between align-items-center mt-3">
            <div>
              <button id="messageTeachers" class="btn btn-sm btn-outline-primary me-2">
                Message Selected
              </button>
          ...
          <footer class="mt-5 text-center text-muted small">
            Saif Academy Admin — Teacher Management
          </footer>
        </main>
      </div>
    </div>
    ...
    <script>
      ...
      // Demo actions
      document.getElementById('importTeachers').addEventListener('click', function () {
        alert('Open CSV import for teachers.');
      });
      document.getElementById('exportTeachers').addEventListener('click', function () {
        alert('Export teachers CSV.');
      });
      ...
      $('#teacherSearch, #courseAssignFilter, #teacherStatusFilter').on(
        'input change',
        function () {
          console.log(
            'Filter changed',
            $('#teacherSearch').val(),
            $('#courseAssignFilter').val(),
            $('#teacherStatusFilter').val()
          );
        }
      );
    </script>
