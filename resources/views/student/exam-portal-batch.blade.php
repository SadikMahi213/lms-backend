...
<html lang="en">
  <head>
    ...
    <title>Exam Portal — Saif Academy</title>
    ...
    <div class="min-h-screen flex">
      ...
      <aside id="sidebar" class="bg-slate-800 text-slate-200 p-4 shadow-lg">
        ...
        <nav class="mt-4">
          ...
          >
          <a href="{{ route('student.exam-portal-batch') }}" class="sidebar-link active"
      ...
      <div class="flex-1 min-h-screen">
        ...
        <header class="bg-white border-b shadow-sm">
          <div class="container-fluid d-flex align-items-center justify-content-between px-4 py-3">
            <div class="d-flex align-items-center gap-3">
              ...
              <small class="text-muted ms-2">Batch-specific Exams</small>
            </div>
        ...
        <main class="p-4 container-fluid">
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <h5 class="mb-3">Exams for Batch: <strong>{{batch_name}}</strong></h5>
                ...
                <table class="table align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{exam_type}}</td>
                      <td>{{exam_date}}</td>
                      <td><span class="badge bg-success">{{exam_status}}</span></td>
                      <td>
                        <a href="{{exam_link}}" class="btn btn-sm btn-primary"
                          ><i class="fa-solid fa-right-to-bracket me-1"></i> Join</a
                        >
                      </td>
                    </tr>
                    <!-- Repeat exam rows -->
