    ...
    <div class="min-h-screen flex">
      ...
      <aside id="sidebar" class="bg-slate-800 text-slate-200 p-4 shadow-lg">
        ...
        <nav class="mt-4">
          ...
          >
          <a href="exam-portal-general.html" class="sidebar-link active"
      ...
      <div class="flex-1 min-h-screen">
        ...
        <header class="bg-white border-b shadow-sm">
          <div class="container-fluid d-flex align-items-center justify-content-between px-4 py-3">
            <div class="d-flex align-items-center gap-3">
              ...
              <small class="text-muted ms-2">All eligible exams</small>
            </div>
        ...
        <main class="p-4 container-fluid">
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <h5 class="mb-3">All Eligible Exams</h5>
                ...
                <table class="table table-hover align-middle">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="take-exam.html?exam_id={{exam_id}}" class="btn btn-sm btn-primary">
                          Start
                        </a>
                      </td>
                    </tr>
                    <!-- Repeat rows for other exams -->
                  </tbody>
                </table>
              </div>
            </div>
