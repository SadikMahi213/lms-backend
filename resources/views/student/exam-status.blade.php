...
<html lang="en">
  <head>
    ...
    <title>Exam Status — Saif Academy</title>
        ...
        <header class="bg-white border-b shadow-sm">
          <div class="container-fluid d-flex align-items-center justify-content-between px-4 py-3">
            <div class="d-flex align-items-center gap-3">
              ...
              <h4 class="mb-0">Exam Status</h4>
              <small class="text-muted ms-2">View grades & feedback</small>
            </div>
          ...
          <div class="row g-3">
            <div class="col-12">
              <div class="card shadow-sm">
                <div class="card-body">
                  <h5 class="mb-3">My Exam Results</h5>
                    ...
                    <table class="table table-hover align-middle">
                      ...
                      <tbody>
                        <tr>
                          <td>{{exam_name}}</td>
                          <td>{{course_title}}</td>
                          <td>{{marks_obtained}} / {{total_marks}}</td>
                          <td><span class="badge bg-success badge-grade">{{grade}}</span></td>
                          <td>{{feedback}}</td>
                        </tr>
