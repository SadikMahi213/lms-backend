...
<html lang="en">
  <head>
    ...
    <title>Teacher Dashboard — Saif Academy</title>
        ...
        <div class="mt-auto px-2 pt-6">
          ...
          <div class="flex gap-2 mt-2">
            <button id="uploadCSVBtn" class="btn btn-sm btn-light w-full">
              <i class="fa-solid fa-file-arrow-up me-2"></i> Upload Results
            </button>
          </div>
        </div>
      </aside>
        ...
        <header class="bg-white border-b shadow-sm">
          <div class="container-fluid d-flex align-items-center justify-content-between px-4 py-3">
            <div class="d-flex align-items-center gap-3">
              ...
              <small class="text-muted ms-2">Teaching Overview</small>
            </div>
